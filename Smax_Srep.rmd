...
$S_{max}$ is the spawners that maximize recruits (spawners ate the peak of the curve)
...
p2 <- ggplot(dfp2) +
  ...
  geom_vline(aes(xintercept=Srep, color=as.factor(Smax))) +
 # geom_vline(aes(xintercept=Smax, color=as.factor(Smax))) +
theme_bw(14)+ scale_color_viridis_d() +ggtitle("Smax varies/ Srep constant")
...
p3 <- ggplot(dfp) +
 ...
 # geom_vline(aes(xintercept=Smax, color=as.factor(Smax))) +
theme_bw(14)+ scale_color_viridis_d() +ggtitle("a and Srep varies")
